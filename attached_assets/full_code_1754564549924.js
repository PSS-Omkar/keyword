...
// // ----- CoinGecko Token Conversion Logic -----
// const MICRO_TOKEN_ID = 'micropets'; // <-- Confirm on CoinGecko
// const TO_CURRENCY = 'usd';          // Use as appropriate
...
// // ----------------------------
// // USD <-> MICROS conversion utilities
// // ----------------------------
// function usdToMicros(usd) {
//   // 1 USD = 1,000,000 micros in Google Ads API
...
// // ----- Core function: fetch ideas, filter, and enrich USD -----
...
//   // Get CoinGecko token price for external enrichment
//   const coinGeckoRate = await getMicroToCurrencyPrice(MICRO_TOKEN_ID, TO_CURRENCY);

//   // If filtering by minbid, convert USD value to micros for bid filter
//   let minbidMicros = minbidUsd !== undefined && minbidUsd !== null ? usdToMicros(minbidUsd) : null;
//   let minKeywordVolume = minkeywordvolume !== undefined && minkeywordvolume !== null ? Number(minkeywordvolume) : null;
...
//   let keywordIdeas = resp.data.results?.slice(0, keywordCount) || [];

//   // Enrich with bid in USD
...
//     const passesVolume = minKeywordVolume ? avgMonthlySearches >= minKeywordVolume : true;
//     const passesBid = minbidMicros ? highTopOfPageBidMicros >= minbidMicros : true;
//     return passesVolume && passesBid;
//   });

//   return {
//     results: keywordIdeas,
//     micropetsToUsdRate: coinGeckoRate,     // for reference
//     minbidMicros,                          // for debugging/reference
//     minKeywordVolume                       // for debugging/reference
//   };
// }
...
//       locationIds = [],
//       keywordCount = 20,
//       minbid,           // User's min bid in USD
//       minkeywordvolume  // User's min avg monthly searches
//     } = req.body;
