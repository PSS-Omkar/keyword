...
export function EditProjectModal({ isOpen, onClose, project }: EditProjectModalProps) {
  ...
  useEffect(() => {
    if (project && isOpen) {
      const topicsString = Array.isArray(project.topics) ? project.topics.join(", ") : "";
      form.reset({
        name: project.name || "",
        topicsInput: topicsString,
        topics: project.topics || [],
        languages: project.languages || [],
        countries: project.countries || [],
        keywordsVolume: project.keywordsVolume || undefined,
        keywordsBid: project.keywordsBid ? parseFloat(project.keywordsBid) : undefined,
        numberOfKeywords: project.numberOfKeywords || 30,
        advertiserId: project.advertiserId || undefined,
        status: project.status || "draft",
      });
      setSelectedLanguages(project.languages || []);
      setSelectedCountries(project.countries || []);
    }
  }, [project, isOpen, form]);
